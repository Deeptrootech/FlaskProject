...
def store_posts(posts_json):
    # Loop through each post in the JSON list
    for post_data in posts_json:
        ...
        post = Post(
            ...
            date_posted=datetime.utcnow()  # Use current date or you can add 'date_posted' to JSON and parse if needed
        )
    ...
    return jsonify({'message': 'Posts stored successfully!'})


# Example JSON data
posts_json = [
    {"title": "My Updated Post", "content": "My first updated post!\r\n\r\nThis is exciting!", "user_id": 1},
    {"title": "A Second Post", "content": "This is a post from a different user...", "user_id": 2},
